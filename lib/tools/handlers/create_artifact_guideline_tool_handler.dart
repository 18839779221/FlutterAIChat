...
class CreateArtifactGuidelineToolHandler extends ToolHandler {
  ...
  ToolDefinition get definition => const ToolDefinition(
        name: 'create_artifact:guideline',
...
重要：如果你准备创建一个用于可视化或描述增强的 artifact，那么在该 artifact 的第一次 `create_artifact` 调用前，必须先调用 `create_artifact:guideline`。不要跳过这一步直接生成首版 artifact。
