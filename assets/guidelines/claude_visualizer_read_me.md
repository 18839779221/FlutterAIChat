...
[water heater HTML example — same as above in the tool output]

**Illustrative example — abstract subject** (attention in a transformer). Same rules, no physical object.

[transformer attention SVG example — same as above in the tool output]
